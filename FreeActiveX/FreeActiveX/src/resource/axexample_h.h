...
#ifndef __axexample_h_h__
#define __axexample_h_h__
...
EXTERN_C const IID IID_IAXControl;
    ...
    MIDL_INTERFACE("C9958507-AA21-46a8-95A6-F1FCA18971F1")
...
EXTERN_C const IID DIID_DAXEvents;
    ...
    MIDL_INTERFACE("75B8DD70-9BB2-41ab-8A0D-FABFDA616C0B")
...
class DECLSPEC_UUID("F773B261-8DD4-45cb-A861-F8AA2A7AEE4B")
AXPlugin;
#endif
